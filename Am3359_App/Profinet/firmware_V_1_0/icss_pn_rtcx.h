...
//  0.2 		Added events and yellow period	tley
//  0.3			Added ARM (host) data               Frank Walzer
//  0.4			Optimizations for easier PRU coding	tley
//  0.5			added yellow time, PTCP_Status,		tley 
//              LineDelayCompensation, ...
//  0.6         added IRT cycle control and red guard 	tley
//  0.7			changed to larger CPM/PPM buffers
//				and clean-up                        Frank Walzer
//  0.8			new RTC descriptor and backplane  	tley
//				support
//  0.9	        MRP fdb_flush mode for PPM			tley
//  1.0         add PPM_SEND_STATUS					tley
//
